package com.cddmiasmin.adoteumpet.api.common.handlers;
...
import com.cddmiasmin.adoteumpet.api.common.dtos.ErrorResponse;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler{
    ...
    private Map<String, List<String>> convertFieldErrors(List<FieldError> fieldErrors){
        ...
        fieldErrors.stream().forEach( fieldError -> {
            ...
            if(errors.containsKey(field)) errors.get(field).add(fieldError.getDefaultMessage());
            else
            {
                errors.put(
                            field, 
